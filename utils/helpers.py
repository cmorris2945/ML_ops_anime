...
def find_similar_animes(name, path_anime_weights, path_anime2anime_encoded, path_anime2anime_decoded, path_df, n=10, return_dist=False, neg=False):
    ...
    ## computer similarity distance...
    dists = np.dot(weights, weights[encoded_index]) ## Ensure weights[encoded_index] is a 
    ...
    for close in closest:
        ...
        Frame = pd.DataFrame(SimilarityArr).sort_values(by="similarity", ascedning=False)
